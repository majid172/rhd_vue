...
import { useEtcBankwiseSummaryStore } from "@/stores/etcBankwiseSummary.js";

// Fetch stores and router
const bridgeStore = useBridgeStore();
const etcSummaryStore = useEtcBankwiseSummaryStore();
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-6">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">ETC Bankwise Report</h5>
      </div>
      ...
      <div class="card-body">
        <form @submit.prevent="validateAndSubmit">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-4">
                <label for="bridgeSelect" class="form-label">Bridge Select <span class="text-danger">*</span></label>
                <select
                  id="bridgeSelect"
                  class="form-select"
            ...
            <div class="col-lg-6" v-if="isBridgeSelected">
              <div class="mb-4">
                <label for="plazaSelect" class="form-label">Select Plaza <span class="text-danger">*</span> </label>
                <select
                  id="plazaSelect"
                  class="form-select"
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-4">
                <label for="date" class="form-label">Select Bank Type <span class="text-danger">*</span></label>
                <select
                  id="banktype"
                  class="form-select"
                  v-model="etcSummaryStore.inputField.bank"
                >
                  <option value="" >Choose Bank Type</option>
                  <option :value="1">Bkash
                  </option>
                  <option :value="2">Upay
                  </option>
                  <option :value="3">Rocket
                  </option>
                </select>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="mb-4">
                <label for="shift" class="form-label">Select Shift <span class="text-danger">*</span></label>
                <select
                  id="shift"
